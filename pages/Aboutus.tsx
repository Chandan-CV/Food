      ...
      <div>
        <div className='mt-10 ml-10 mr-10 flex flex-col flex-1 min-h-full'>
          ...
          <div className='w-2/3'>
            ...
            <p className='text-lg mb-3'>{`Anna Brahma has made it's mission to bring food to those who need it. We aim reduce food wastage and strive to create a society where not even a single morsel goes to waste. We hope to pave the way for a better future where no person is hungry. We also aim to make a sustainable society by  unnecessary food production, reducing carbon emissions and conserving our resources.`}</p>
          </div>
